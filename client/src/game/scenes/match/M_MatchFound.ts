...
export default class M_MatchFound extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		playerName_1.setStyle({ "align": "center", "fontFamily": "Arial", "fontSize": "64px", "fontStyle": "bold" });
		...
		vs.text = "V.S";
		vs.setStyle({ "align": "center", "fontFamily": "Arial", "fontSize": "128px", "fontStyle": "bold" });
	...
	addIdleAnimation(charSprite: Phaser.GameObjects.Image, isEnemy: boolean = false) {
