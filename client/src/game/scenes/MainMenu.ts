...
export default class MainMenu extends Phaser.Scene {
	...
	editorCreate(): void {
		...
		const leaderboardsContainer = this.add.image(464, 544, "2G_btnsBackground");
    ...
    create() {
        ...
        this.nameContainer.setScale(this.nameContainer.scaleX * 0.5, this.nameContainer.scaleY * 0.5);
        ...
        this.leaderboardsContainer.setScale(this.leaderboardsContainer.scaleX * 0.8, this.leaderboardsContainer.scaleY * 0.8);
                            ...
                            onComplete: () => {
                                ...
                                this.tweens.add({
                                    ...
                                    onComplete: () => {
                                        ...
                                        const circle = this.add.circle(this.btnARENA.x, this.btnARENA.y, 50, 0x000000);
                                        circle.depth = 999;
        ...
        const setupCasualTransition = (button: Phaser.GameObjects.Image, targetScene: string) => {
