...
export interface Sample3WildTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface Sample3WildToken extends BaseContract {
  connect(runner?: ContractRunner | null): Sample3WildToken;
  waitForDeployment(): Promise<this>;

  interface: Sample3WildTokenInterface;
