...
export type { AddPoints } from "./contracts/AddPoints";
export { AddPoints__factory } from "./factories/contracts/AddPoints__factory";
export type { ClaimTokens } from "./contracts/ClaimTokens";
export { ClaimTokens__factory } from "./factories/contracts/ClaimTokens__factory";
export type { Sample3WildToken } from "./contracts/ERC20.sol/Sample3WildToken";
export { Sample3WildToken__factory } from "./factories/contracts/ERC20.sol/Sample3WildToken__factory";
